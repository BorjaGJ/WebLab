...
urlpatterns = [
    ...
    url(r'^volumetrico/detalle/(?P<codigo_laboratorio>[-\w]+)$', login_required(views.DetalleVolumetricoView.as_view()),
    ...
    url(r'^instrumento/detalle/(?P<codigo_laboratorio>[-\w]+)$', login_required(views.DetalleInstrumentoView.as_view()),
    ...
    url(r'^miscelanea/detalle/(?P<codigo_laboratorio>[-\w]+)$', login_required(views.DetalleMiscelaneaView.as_view()),
